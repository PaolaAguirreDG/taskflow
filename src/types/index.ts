...
export const CATEGORIES: Record<Category, { label: string; color: string; soft: string; emoji: string }> = {
  trabajo: { label: 'Trabajo', color: '#2db33e', soft: '#e0ffe3', emoji: '💼' },
  personal: { label: 'Personal', color: '#FE64A3', soft: '#FFE9F3', emoji: '🌱' },
  estudio: { label: 'Estudio', color: '#9B59D0', soft: '#F3E9FB', emoji: '📚' },
  hogar: { label: 'Hogar', color: '#f3a145', soft: '#fef4e8', emoji: '🏠' }
}
